...
@section('content')
    ...
    <div class="content-header">
      <div>
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="fas fa-dumpster"></i> Despacho Domiciliario</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('aseourbano')}}">Home</a></li>       
              <li class="breadcrumb-item active">Despacho Domiciliario</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
                        ...
                        <div class="container">
                            <div class="dropdown">
                                ...
                                <div class="dropdown-menu">
                                  ...
                                  <a class="dropdown-item" href="{{route('detalledespachos', $despacho->id)}}">Rutas</a>
                                  
                                  @if($despacho->estado == 0)
                                    <a class="dropdown-item" href="{{route('au-despacho.prinft', $despacho->id)}}">Imprimir</a> 
                                  @endif          
                                </div>
                            </div>
                        </div>
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-body">
            {!! Form::open(['route' => 'despacho.store', 'class' => 'was-validated'])!!}
