...
@section('content')
    ...
    <div class="content-header">
      <div>
        <div class="row mb-2">
          <div class="col-sm-6">
            <h1 class="m-0 text-dark"><i class="far fa-object-ungroup"></i> Tipo Servicio</h1>
          </div><!-- /.col -->
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a href="{{route('aseourbano')}}">Home</a></li>       
              <li class="breadcrumb-item active">Tipo Servicio</li>
            </ol>
          </div><!-- /.col -->
        </div><!-- /.row -->
      </div><!-- /.container-fluid -->
...
<div class="container" style="width: 70%">
   <div style="padding-bottom: 5px;">
      <a class="btn btn-warning" data-toggle="tooltip" href="" title="Volver al menu principal">
        ...
        <a class="btn btn-success" data-toggle="modal" data-target="#modalRegistrar" title="Registrar Tipo de Servicio">
          <i class="fas fa-plus">
          </i>
          Registrar
        </a>@can('adm-grupoempresa.store')
      @endcan
   </div>
                ...
                <tr style="text-transform:uppercase">
                  ...
                  @can('adm-grupoempresa.update')
                    <td class="text-center" style="width: 5%">
                      <a class="btn btn-primary btn-sm" data-toggle="modal" data-target="#modalEditar" data-id="{{$tipo->id}}" data-nombre="{{$tipo->descripcion}}" title="Editar Tipo de Sercicio">
    ...
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <div class="modal-header bg-success">
          <h4 class="modal-title">Registrar Tipo de Servicio</h4>
          <button type="button" class="close" data-dismiss="modal">&times;</button>
        </div>
        
        <!-- Modal body -->
        <div class="modal-body">
        {!! Form::open(['route' => 'tiposervicioaseo.store', 'class' => 'was-validated'])!!}
...
<div class="modal fade" id="modalEditar">
  <div class="modal-dialog">
    <div class="modal-content">
      ...
      <!-- Modal body -->
      <div class="modal-body">
      {!! Form::open(['route' => 'au-tiposervicio.update','class' => 'was-validated']) !!}
