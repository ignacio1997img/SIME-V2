        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
                ...
                <li class="breadcrumb-item"><a href="{{route('barridoruta.index')}}">RT Barrido</a></li>            
    ...
    <div id="print">
        ...
        <div class="text-center" style="padding: 5px;">    
            <div class="container text-center" style="padding: 5px;">
                ...
                <div class="row">
                    <div class="col-6">
                        <div class="input-group mb-2">
                            ...
                            <input type="text" class="form-control" value=""  style="text-transform:uppercase" disabled>
                        </div>
                    </div>
                    <div class="col-6">
                        <div class="input-group mb-2">
                ...
                <div>
                    <!-- <img src="" alt=""> -->
                    <img src="{{ asset('../storage/files/aseourbano/'.$rutas->urlimg)}}" width="100%">
                </div>
